...
`scripts/e2e-m3-pointscore-120.cjs` after v2.11.0 Slice 2: **118 PASS / 2 NOT APPLICABLE / 0 FAIL / 0 BLOCKED / 0 CLIENT INPUT MISSING** (120/120 classified). Unit `15 PASS / 0 FAIL`. Slice2 Unit/API `7 PASS / 0 FAIL`. Slice2 Browser/UI/File `13 PASS / 0 FAIL`. Isolation `PASS`. M2 regression `55 PASS / 0 FAIL` and `98 PASS / 2 NA / 0 FAIL / 0 BLOCKED`. History-graphs `19 PASS / 1 NA / 0 FAIL`.

The 2 NOT APPLICABLE 120-cases are documented, not skipped: brace (UIT-M3-029) and pogo (UIT-M3-031) team races are engine-proven through relay categorization and the relay/team 5/4/3 rule is exercised via medley_relay (UIT-M3-030). 75m/breaststroke/butterfly are seeded end-to-end (UIT-M3-025/027/028 PASS). v2.11.0 adds the previously missing improvement and break-count report cases, so the 120 gate now has 0 CLIENT INPUT MISSING.
