...
| TC-09 | R7: Total/Target/Color | JA | PASS | Headers + Gold coding |
...
| TC-18a | R16: Pogo 4-per-team | JA | PASS | 3 teams × 4 swimmers |
| TC-18b | R16: No Swim Twice | JA | PASS | Button absent in Pogo HB |
| TC-18c | R16: No Team Total | JA | PASS | Footer absent in Pogo HB |
| TC-04 | R3: Print Layout | PARTIAL | PASS | CSS added, no real print test |
